...
namespace dms.pages.Utils
{
    class PrintDGV
    {
        ...
        public static void Print_DataGridView(DataGridView dgv1, string title = "", bool fitToPage = true, List<string> selectedColumns = null)
        {
            ...
            try
            {
                ...
                PrintTitle = title;
                PrintAllRows = true;
                FitToPageWidth = fitToPage;
                SelectedColumns = selectedColumns == null ? AvailableColumns : selectedColumns;
                RowsPerPage = 0;

                ppvw = new PrintPreviewDialog();
                ppvw.Size = new Size(1200, 900);
                    ...
                    int RowsPerPage)
        {
            ...
            string PageNum = PageNo.ToString() + " из " +
