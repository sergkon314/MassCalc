...
namespace dms.pages.Main
{
    ...
    {
        /*
        protected dmsMass.mass_projectDataTable dt_projects = new dmsMass.mass_projectDataTable();
        protected dmsMass.mass_bidDataTable dt_bids;
        protected dmsMass.mass_data_bidDataTable dt_data;
        protected dmsMass.mass_text_codeDataTable dt_codes = new dmsMass.mass_text_codeDataTable();
        protected dmsMassTableAdapters.mass_text_codeTableAdapter ta_codes = new dmsMassTableAdapters.mass_text_codeTableAdapter();
        protected dmsMassTableAdapters.mass_data_bidTableAdapter ta_data = new dmsMassTableAdapters.mass_data_bidTableAdapter();
        protected dmsMassTableAdapters.mass_bidTableAdapter ta_bids = new dmsMassTableAdapters.mass_bidTableAdapter();
        protected dmsMassTableAdapters.mass_projectTableAdapter ta_projects = new dmsMassTableAdapters.mass_projectTableAdapter();
        */
            ...
            : base(o, name)
        {
            ...
            /*
            ta_codes.Connection.ConnectionString = MysglConString;
            ta_data.Connection.ConnectionString = MysglConString;
            ta_bids.Connection.ConnectionString = MysglConString;
            ta_projects.Connection.ConnectionString = MysglConString;
             */ 
        }
        ...
        //protected virtual float CalcSum(ref dmsMass.mass_data_bidDataTable dt)
        //{
        //    int count = dt.Rows.Count;
        //    if (count == 0) return 0;
        //    gb_sum.Text = "Суммы";
        //    float M = 0, X = 0, Y = 0, Z = 0, Mx = 0, My = 0, Mz = 0;
        //    foreach (dmsMass.mass_data_bidRow r in dt)
        //    {
        //        M += r.m; Mx += r.mx; My += r.my; Mz += r.mz;
        //    }
        ...
        //protected virtual uint GetBidCurrentClaim(dmsMass.mass_bidRow row)
        //{
        //    uint claim = (uint)ta_bids.GetBidClaim(Convert.ToInt32(row.id));
        //    if (claim != row.claim)
        //    {
        //        row.claim = claim;
